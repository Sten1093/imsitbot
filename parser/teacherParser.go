...
func GetTeacher() []Teacher {
	return []Teacher{
		...
		{"Нестерова", "Нестерова Н.С.", " Нонна Семеновна", "\n", "./resources/images/teacher/Нестерова Нона Семеновна.jpg"},                                                                           //AgACAgIAAxkBAAIMQmezmVKygv4Y_SK-bvl3U6cK-T2WAAIg6jEbElWZSWI2mjpgjbaIAQADAgADbQADNgQ
		...
		{"Пальников", "Пальников А.В.", " Александр Валерьевич", "\n", "./resources/images/teacher/пальников Алексанр Валерьевич.jpg"},                                                                 //AgACAgIAAxkBAAIMRmezmVpLm_wlh25TL6zTZBiDdouMAAIi6jEbElWZSc_EMTQqesWjAQADAgADeAADNgQ
